...
<a href="${logout}"><button type="submit">Logout</button></a>
  ...
  <form:form action="${adminPost}" modelAttribute="workoutPost" method="POST">
    ...
    <div>
        ...
        <form:input path="workoutName"/>
        <form:errors path="workoutName" cssClass="error" />
      </div>
    <div>
    ...
    <div>
       <label class="label" for="videolink">Video Link</label>
        ...
        <form:errors path="videolink" cssClass="error" />
      </div>
    <div>
        <label class="label" for="timeLength">Time Duration</label>
        <form:input path="timeLength"/>
        <form:errors path="timeLength" cssClass="error" />
      </div>
      <div>
        <label class="label" for="bodyLocation">Body Location</label>
        <form:input path="bodyLocation"/>
        <form:errors path="bodyLocation" cssClass="error" />
      </div>
      <div>
        <label class="label" for="typesOfExercise">Types Of Exercise</label>
        <form:input path="typesOfExercise"/>
        <form:errors path="typesOfExercise" cssClass="error" />
      </div>
      <div>
        <label class="label" for="choiceThatFallUnder">Choice That Fall Under</label>
        <form:input path="choiceThatFallUnder"/>
        <form:errors path="choiceThatFallUnder" cssClass="error" />
      </div>
