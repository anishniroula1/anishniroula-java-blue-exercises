...
select name, continent, gnp, lifeexpectancy from country where (gnp between 1 and 100) and lifeexpectancy >70;
...
select (2019-indepyear) as independence from country where indepyear is not null;
