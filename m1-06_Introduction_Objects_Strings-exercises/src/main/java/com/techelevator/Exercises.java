...
public class Exercises {
	...
	public String helloName(String name) {
		...
		String explanation = "!";
		return greeting + name+explanation; 
	}
	...
	public String extraEnd(String str) {
		String newChar = str.substring(str.length()-2);

		String newCount = newChar +newChar+newChar;
	...
	public String firstHalf(String str) {
		String newFirstHalf = str.substring(0,str.length()/2);
		return newFirstHalf;
	}
	...
	public String right2(String str) {
		if(str.length()>2) {
			String newRotated = str.substring(str.length()-2);
			String firstR = str.substring(0,str.length()-2);
			return newRotated + firstR;
		}
		return str;
	}
	...
	public String middleTwo(String str) {
		String leftMiddle = str.substring(str.length()/2-1, str.length()/2);
		String rMiddle = str.substring(str.length()/2, str.length()/2+1);
		return leftMiddle + rMiddle;
	}
	...
	public boolean endsLy(String str) {
		if(str.length()>1) {
		String newEnd = str.substring(str.length()-2);
		return newEnd.equals("ly");
	...
	public String middleThree(String str) {
		int newS= str.length()/2-1;
		int secOn = str.length()/2+2;				
		return str.substring(newS,secOn);
	}
	...
	public boolean doubleX(String str) {
		for(int i= 0; i<str.length()-1; i++) {
			if(str.substring(i,i+1).contains("x")) {
				if(str.substring(i+1,i+2).contains("x")) {
				return true;
			}
			else {
				return false;
	...
	public String stringX(String str) {
		...
		String otherString = str.substring(str.length()-1);

		String anotherAn = str.substring(1,str.length()-1);
		String otherNext = anotherAn.replace("x", "");

				
				return newString+otherNext+otherString;
	}
